...
Write-Host "Programando Spring Batch JOB remoto con orden de ejecución API Rest (modo sincrono)..." -ForegroundColor Yellow
$scheduleBody = @{
...
try {
    ...
    Write-Host "  OK - Job de lanzamiento programado: $($response.jobId)" -ForegroundColor Green
